...
jest.mock('hooks/useUsers', () => () => ({
  isLoading: false,
  data: [
    { url: 'user1', avatar_url: 'https://example.com/avatar1.jpg', login: 'user1' },
    { url: 'user2', avatar_url: 'https://example.com/avatar2.jpg', login: 'user2' },
  ],
  isSuccess: true,
  isError: false,
}));
...
describe('Home component', () => {
  ...
  it('renders user avatars correctly', () => {
    ...
    const avatarElements = screen.getAllByTestId('avatar') as HTMLImageElement[];
    expect(avatarElements.length).toBe(2); // Assuming we have 2 mock users

    // Ensure that the avatar URLs and titles are correct
    const user1 = { url: 'user1', avatar_url: 'https://example.com/avatar1.jpg', login: 'user1' };
    const user2 = { url: 'user2', avatar_url: 'https://example.com/avatar2.jpg', login: 'user2' };
